...
def test(model, history_list, test_list, num_rels, num_nodes, use_cuda, all_ans_list, all_ans_r_list, model_name, static_graph, mode):
    ...
    :param history_list:    all input history snap shot list, not include output label train list or valid list (whatever you have in your kg)
    :param test_list:   test triple snap shot list (new input for your kg)
